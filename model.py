  ...
  def _build_loss(self):
    ...
    with tf.name_scope("discriminator"):
      self.refiner_d_loss = log_loss(
          #fake_label function returns a tensor filled with zeros
          self.D_R_x_logits, fake_label(self.D_R_x_logits), "refiner_d_loss")
      self.synthetic_d_loss = log_loss(
          #real_label function returns a tensor filled with ones
      ...
      self.discrim_loss_with_history = tf.reduce_mean(
          #tf.concat_v2 concatenates tensors along one dimension
          #t1 = [[1,2,3],[4,5,6]]
          #t2 = [[7,8,9],[10,11,12]]
